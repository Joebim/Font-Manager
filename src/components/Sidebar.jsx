        ...
        <div className={`h-[100vh] relative overflow-hidden duration-[0.5s] ${sidebarToggle ? "w-[200px]" : "w-0"}  bg-white`}>
            <div className='w-full flex flex-col px-[10px] text-center items-center'>
                ...
                <div className="flex flex-col my-[25px] w-full justify-center">
                    <div className=' text-[#575757] font-semibold hover:text-black mb-[10px] cursor-pointer'>Home</div>
                    <div className=' text-[#575757] font-semibold hover:text-black mb-[10px] cursor-pointer'>App</div>
                    <div className=' text-[#575757] font-semibold hover:text-black mb-[10px] cursor-pointer'>Pricing</div>
                    <div className=' text-[#575757] font-semibold hover:text-black mb-[10px] cursor-pointer'>Partner</div>
                    <div className=' text-[#575757] font-semibold hover:text-black mb-[10px] cursor-pointer'>AboutUs</div>
                </div>
